...
class Module:
    ...
    # --- [Boilerplate Registration Helpers: 1677-1697] ---
    def register_parameter(self, name: str, param):
        ...
        if not isinstance(param, Value) and param is not None:
            raise TypeError(f"cannot assign {type(param)} as parameter '{name}' (Value or None expected)")
    ...
    # --- [Boilerplate Parameter Discovery: 1699-1714] ---
    ...
    def parameters(self):
        ...
        """
        # Yield only the parameter Value objects
    ...
    # --- [Boilerplate Saving and Loading Logic: 1744-1801] ---
    def state_dict(self):
    ...
    # --- [Boilerplate Automatic Registration: 1802-1847] ---
