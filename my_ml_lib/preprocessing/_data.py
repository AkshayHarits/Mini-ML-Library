...
class StandardScaler:
    ...
    def fit(self, X, y=None):
        ...
        Args:
            X (np.ndarray): The data used to compute the mean and
                            standard deviation,
        ...
        # We replace scale with 1 in these cases to avoid NaN results.
    ...
    def transform(self, X):
        ...
        Args:
            X (np.ndarray): The data to scale, shape (n_samples,
                            n_features).
        ...
        # Apply the transformation: X_scaled = (X - mean) / scale
    ...
    def fit_transform(self, X, y=None):
        ...
        Args:
            X (np.ndarray): The data to fit and transform, shape
